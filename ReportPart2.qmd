...
for store in [int(store) for store in stores]:
  ...
  # Create darts TS, fill gaps
  covars = TimeSeries.from_dataframe(covars, freq = "D") 
...
Fix / wait for fix on the all the input array dimensions for the concatenation axis must match exactly error in RANDOM FOREST
...
# Retrieve validation store sales minus linear model predictions
