...
# Naive
scores_hierarchy(ts_sales["AUTOMOTIVE":"SEAFOOD"][-227:], pred_drift_cat, categories, "Naive drift")

scores_hierarchy(ts_sales["AUTOMOTIVE":"SEAFOOD"][-227:], pred_seasonal_cat, categories, "Naive seasonal")

# AutoARIMA
scores_hierarchy(ts_sales["AUTOMOTIVE":"SEAFOOD"][-227:], pred_arima_cat, categories, "AutoARIMA")
...
model_dlinear_cat.fit(
  series = y_train_cat,
  future_covariates = [x[dlinear_covars] for x in x_train_cat],
  val_series = y_val_cat,
  val_future_covariates = [x[dlinear_covars] for x in x_val_cat],
  verbose = True,
