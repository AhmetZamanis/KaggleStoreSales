...
#   max_Q = 7,
#   m = 7,
#   seasonal = True, # Don't include seasonal orders
...
# # AutoARIMA
# arima_covars = ['local_holiday', 'regional_holiday', 'national_holiday', 'ny1', 'ny2', 'ny_eve31', 'ny_eve30', 'xmas_before', 'xmas_after', 'quake_after', 'dia_madre', 'futbol', 'black_friday', 'cyber_monday', 'oil', 'oil_ma28', 'onpromotion', 'onp_ma28', 'transactions', 'trns_ma7', 'day_sin', 'day_cos']
# 
...
RNN loss is computed on output sequences of training length - input_chunk_length. Try a full year of input chunk length + 15 = training length?
