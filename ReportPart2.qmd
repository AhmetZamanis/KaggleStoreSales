...
```
    ...
    --------
    Model = Linear (trend + seasonality features)
    ...
    --------
    Model = Linear + AutoARIMA (calendar + cyclical features)
    ...
    --------
    Model = Linear + Random forest (calendar + cyclical features)
...
```
    ...
    --------
    Model = Linear + RNN (global) (calendar + cyclicality feats)
    MAE: mean = 2629.96, sd = 1390.25, min = 762.26, max = 8993.99
    MSE: mean = 15303460.93, sd = 24028177.44, min = 1126629.43, max = 163453843.88
    RMSE: mean = 3380.1, sd = 1969.36, min = 1061.43, max = 12784.91
    RMSLE: mean = 0.73, sd = 0.36, min = 0.34, max = 3.31
    --------
