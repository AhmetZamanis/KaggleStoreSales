...
model_dlinear = model_dlinear.load_from_checkpoint("DLinearStore1.0", best = True)
...
model_rnn.fit(
  ...
  val_series = [y[-30:] for y in remainder_store], # Use last 45 values in training set as validation set
...
model_rnn = model_rnn.load_from_checkpoint("RNNStore1.0", best = True)
...
store_preds_dict = {
  ...
  "Linear + RNN": trafo_zero(pred_linear_store + pred_rnn_store),
  "D-Linear": trafo_zero(pred_dlinear_store),
  "D-Linear + RNN": trafo_zero(pred_dlinear_store + pred_rnn_store)
}
