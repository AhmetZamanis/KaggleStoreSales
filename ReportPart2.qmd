...
# Naive stacked
pred_naive_total = (trafo_exp(pred_drift_total) + trafo_exp(pred_seasonal_total)) - ts_sales["TOTAL"].last_value()
...
# Score model
perf_scores(y_val_total, pred_total, model="Linear + linear hybrid, total sales")
```
