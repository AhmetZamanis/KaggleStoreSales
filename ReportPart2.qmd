...
store_preds_dict = {
  ...
  "ETS (best baseline)": trafo_zeroclip(pred_ets_store),
  "D-Linear + RNN (best hybrid)": trafo_zeroclip(pred_dlinear2_store + pred_rnn_store),
  "TFT (best model)": trafo_zeroclip(pred_tft_store)
}
...
print("Bottom-up method won't change the bottom level performance")
...
print("Top-down method won't change the top level performance")
print("--------")
