...
-   It\'s also notable that the naive seasonal model beats the FFT model in all metrics, while ETS scores close to naive seasonal on MAE, RMSE and RMSLE, but much worse on MAPE.
