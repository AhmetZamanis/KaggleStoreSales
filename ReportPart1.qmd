...
-   This is likely because MAPE is a measure of relative error, while RMSE and RMSLE are measures of absolute error.
    ...
    -   In both cases, the absolute error is the same, but we may argue it's more "costly" for the former case.

-   RMSLE stands for root mean squared log error. Log errors penalize underpredictions more strongly than overpredictions, which could be good for assessing sales predictions, as unfulfilled demand is likely more costly than overstocking. The competition is scored on RMSLE.
