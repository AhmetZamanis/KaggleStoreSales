...
-   Combining model 1 with a second linear increases our RMSE, while reducing our RMSLE and especially MAPE.
...
-   The first lag has a positive coefficient, so a higher value for lag 1 means a higher prediction for sales at T=0.

-   Lag 2 and the forecast error of lag 1 have a negative effect on the prediction. If lag 2 or the error of lag 1 increase, the prediction for T=0 is pulled back.
